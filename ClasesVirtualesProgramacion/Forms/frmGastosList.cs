    ...
    public partial class frmGastosList : Form
    {
        ...
        private void frmGastosList_Load(object sender, EventArgs e)
        {
            ...
            if (oConexion.SelectData(SelectSQL, dsClasesVirtuales.Gastos) != true)
                MessageBox.Show("No se ha podido cargar el dato de gastos, contacte al departamento de desarrollo técnico", "Sin datos", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void btnNuevo_Click(object sender, EventArgs e)
        {
            ...
            if (frmNuevo.DialogResult == DialogResult.OK)
            {
                ...
                if (oConexion.AccionSQL(sqlInsert) == true)
                {
                    ...
                    MessageBox.Show("La informacion de Gastos ha sido almacenada correctamente.", "Guardar", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            if (gastosBindingSource.Count > 0)
            {
                if (MessageBox.Show("Asegurese de querer eliminar la información de los Gastos, Desea eliminar permanentemente este registro?", "Eliminar", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == DialogResult.Yes)
                {
                    ...
                    {
                        this.frmGastosList_Load(null, null);
                        MessageBox.Show("La informacion de Gastos ha sido eliminada permanentemente.", "Eliminar", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        gastosDataGridView.Focus();
                    }
                }
            }
            ...
            {
                MessageBox.Show("No hay información para eliminar el registro.", "Eliminar", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Por favor escriba un criterio para realizar la búsqueda de un gasto.", "Buscar", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    txtCriterio.Focus();
                    return;
                }
                else
